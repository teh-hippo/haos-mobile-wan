...
def build_status_issues(
    ...
    last_error: str | None,
    upstream_status: dict[str, object],
...
def _issue_from_upstream(upstream_status: dict[str, object]) -> dict[str, object] | None:
...
def _issue_from_error(error: str) -> dict[str, object] | None:
    exact = {
