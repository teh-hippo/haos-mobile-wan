...
WIFI_NOT_ASSOCIATED = host_faults.HOTSPOT_NOT_ASSOCIATED.text
WIFI_PROFILE_DRIFT_MESSAGE = upstream_faults.WIFI_PROFILE_DRIFT.text
WIFI_ROUTE_MESSAGE = (
    ...
    def inspect(self) -> NetworkManagerResult:
        try:
            ...
            return NetworkManagerResult(
                None,
                "waiting",
                upstream_faults.WIFI_INSPECTION_WAITING.text,
                True,
            )
